...
print("W 平均錯誤值（Ein）：")
print(ridge.calculate_avg_error(ridge.train_X, ridge.train_Y, ridge.W))
...
input_test_data_file = os.path.join(os.path.join(os.getcwd(), os.path.dirname(__file__)), 'library/iNDIEVOX-Dataset/dataset/valence_test.dataset')
